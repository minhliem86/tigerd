...
@section('content')
    <div class="row">
      <div class="col-sm-12">
        <form method="POST" action="{{route('admin.pages.store')}}" id="form" role="form" class="form-horizontal">
          {{Form::token()}}
            <fieldset>
                <div class="form-group">
                    <label class="col-md-2 control-label">Tên Trang:</label>
                    <div class="col-md-10">
                        <input type="text" required="" placeholder="Tên Trang Đơn" id="name" class="form-control" name="name">
                    </div>
                </div>
                <div class="form-group">
