...
@section('link')
    {{Html::link(route('admin.shippingcost.create'),'Add New',['class'=>'btn btn-primary'])}}
    ...
    <script>
      $(document).ready(function(){
        ...
        var table = $('table').DataTable({
            ...
            serverSide: true,
            ajax:{
                url:  '{!! route('admin.shippingcost.getData') !!}',
                data: function(d){
           ...
           initComplete: function(){
                ...
                $('#btn-remove-all').click( function () {
                    ...
                    alertify.confirm('You can not undo this action. Are you sure ?', function(e){
                        if(e){
                            $.ajax({
                                'url':"{!!route('admin.shippingcost.deleteAll')!!}",
                ...
                $('#btn-updateOrder').click(function(){
                    ...
                    $.ajax({
                        url: '{{route("admin.shippingcost.postAjaxUpdateOrder")}}',
                        type:'POST',
                ...
                $('input[name="status"]').change(function(){
                    ...
                    console.log(id_item);
                    $.ajax({
                        url: "{{route('admin.shippingcost.updateStatus')}}",
                        type : 'POST',
