                ...
                <div class="col-md-6">
                    <div class="wrap-attribute flex-container">
                        ...
                        <div class="wrap-btn flex-item text-right">
                            <button type="button" class="btn btn-xs btn-warning" data-toggle="modal" data-target="#modal-add-value" data-att-id="{!! $item_attr->id !!}" data-att-slug="{!! $item_attr->slug !!}" disabled id="btn-att-create-{!! $item_attr->slug !!}" data-toggle="tooltip" title="Thêm Giá Trị"><i class="fa fa-plus"></i> Thêm Giá Trị</button>
