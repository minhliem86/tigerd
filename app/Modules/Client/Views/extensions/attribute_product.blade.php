        ...
        <div class="each-attribute">
            ...
            @if(!$item_attribute->attribute_values->isEmpty())
                ...
                <div class="custom-control custom-radio mb-3">
                    <input type="radio" id="{!! LP_lib::unicode($item_att_value->value) !!}" name="att_value[{!! $item_attribute->id !!}]" class="custom-control-input attribute_product" value="{!! $item_att_value->id !!}" required/>
