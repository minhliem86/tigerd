                                ...
                                <td width="100%" style="margin: 0; padding: 0; vertical-align: top;">
                                    <table border="0" cellspacing="0" cellpadding="0" style="margin: 0; padding: 0;">
                                        ...
                                        <tr style="margin: 0; padding: 0;">
                                            ...
                                            <td style="margin: 0; padding: 0; vertical-align: top;">
                                                <a href="http://tigerd.vn" style="margin: 0; padding: 0; text-decoration: none !important;"><img src="logo-email.png" width="80" height="53" alt="TigerD" style="display: block; margin: 0; padding: 0;"></a>
                                            </td>
                                            <td style="margin: 0; padding: 0; vertical-align: top;">
                                                <p class="width-space-header" style="font-family: 'Arial', sans-serif; font-size: 12px; height: 100%; line-height: 18px; margin: 0; padding: 0; width: 15px;">&nbsp;</p>
                                            </td>
                                        ...
                                        <tr style="margin: 0; padding: 0;">
                                            ...
                                            <td style="margin: 0; padding: 0; vertical-align: top;">
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="order-infor" style="margin: 0; padding: 0;">
                                                                ...
                                                                <tr style="margin: 0; padding: 0;">
                                                                    <td class="title-order" colspan="2" style="border-bottom: 1px solid #cccccc; margin: 0; padding: 0; padding-bottom: 5px; padding-top: 8px; vertical-align: top;">
                                                                        <p class="title" style="font-family: 'Arial', sans-serif; font-size: 12px; line-height: 18px; margin: 0; padding: 0;"><span class="hong" style="color: #e39bab; font-weight: 600; margin: 0; padding: 0;">THÔNG TIN ĐƠN HÀNG #{!! $order_no !!}</span> <span class="time" style="margin: 0; padding: 0;">({!! Carbon\Carbon:: !!})</span></p>
                                                                    </td>
                                                                </tr>
                                                                <tr style="margin: 0; padding: 0;">
                                                                    ...
                                                                    <td width="50%" style="margin: 0; padding: 0; padding-bottom: 8px; padding-top: 8px; vertical-align: top;">
                                                                        ...
                                                                        <p class="space-text-content" style="font-family: 'Arial', sans-serif; font-size: 12px; line-height: 18px; margin: 0; padding: 0;">&nbsp;</p>
                                                                        <p class="text" style="font-family: 'Arial', sans-serif; font-size: 12px; line-height: 18px; margin: 0; padding: 0;">Le Tran Tra My</p>
                                                                        <p class="space-text-content" style="font-family: 'Arial', sans-serif; font-size: 12px; line-height: 18px; margin: 0; padding: 0;">&nbsp;</p>
                                                                        <p class="text" style="font-family: 'Arial', sans-serif; font-size: 12px; line-height: 18px; margin: 0; padding: 0;">{!! $information_shipper->address !!}, {!!DB::table('wards')->where('code',$order->shipAddress->ward)->first() ? DB::table('wards')->where('code',$order->shipAddress->ward)->first()->name_with_type : null !!}, {!!DB::table('district')->where('code',$order->shipAddress->district)->first() ? DB::table('district')->where('code',$order->shipAddress->district)->first()->name_with_type : null !!}, {!!DB::table('cities')->where('code',$order->shipAddress->city)->first() ? DB::table('cities')->where('code',$order->shipAddress->city)->first()->name_with_type : null !!}   </p>
                                                                        <p class="space-text-content" style="font-family: 'Arial', sans-serif; font-size: 12px; line-height: 18px; margin: 0; padding: 0;">&nbsp;</p>
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="detail-order" style="background: #f1f1f1; margin: 0; padding: 0;">
                                                    ...
                                                    <tbody style="margin: 0; padding: 0;">
                                                        ...
                                                        @foreach($cart as $item_cart)
                                                            <tr style="margin: 0; padding: 0;">
                                                                ...
                                                                <td style="margin: 0; padding: 10px 5px; vertical-align: top;">
                                                                    <p class="text" style="font-family: 'Arial', sans-serif; font-size: 12px; line-height: 18px; margin: 0; padding: 0;">29.000 vnd</p>
                                                                </td>
                                                    ...
                                                    <tr style="margin: 0; padding: 0;">
                                                        ...
                                                        <td align="right" style="margin: 0; padding: 6px 5px; vertical-align: top;">
                                                            <p class="text" style="font-family: 'Arial', sans-serif; font-size: 12px; line-height: 18px; margin: 0; padding: 0;">{!! number_format(Cart::getTotal()); !!} vnd</p>
                                                        </td>
                                                    </tr>
                                                    <tr style="margin: 0; padding: 0;">
                                                        <td colspan="3" align="right" style="margin: 0; padding: 6px 5px; vertical-align: top;">
                                                    ...
                                                    <tr style="margin: 0; padding: 0;">
                                                        ...
                                                        <td align="right" style="margin: 0; padding: 6px 5px; vertical-align: top;">
                                                            <p class="text" style="font-family: 'Arial', sans-serif; font-size: 12px; line-height: 18px; margin: 0; padding: 0;"><b style="margin: 0; padding: 0;">{!! number_format(Cart::getTotal() + $shipping_cost); !!} vnd</b></p>
                                                        </td>
                                                    </tr>
                                                    </tfoot>
                                                    @endif
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 0; padding: 0;">
                                                    ...
                                                    <tr style="margin: 0; padding: 0;">
                                                        <td style="margin: 0; padding: 0; vertical-align: top;">
                                                            <p class="text" style="font-family: 'Arial', sans-serif; font-size: 12px; line-height: 18px; margin: 0; padding: 0;">Truy cập tigerD.vn, hoặc gọi số điện thoại 1900 6035 (8-21h cả T7,CN) để gặp nhân viên chăm sóc khách hàng khi quý khách cần hỗ trợ.</p>
                                                            <p class="space-text-content" style="font-family: 'Arial', sans-serif; font-size: 12px; line-height: 18px; margin: 0; padding: 0;">&nbsp;</p>
